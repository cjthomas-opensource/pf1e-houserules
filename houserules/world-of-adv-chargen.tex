...
``Expert'' or ``Expert (Magical)'') rather than a playable class.
%
\end{itemize}

About one person in a thousand decides to pursue an adventuring career; in
a city of half a million people, there are a few hundred. The authorities
...
+8 Swim &
% SRD says 1d3 bite, 1d4 claws, but that doesn't match other critters.
bite (1d4 P)\par claws (1d3 S)\par natural armour 1 \\ \hline
%
Orc & +2 any &
+2 Intimidate &
...
``Profession: Adventurer'' is an option (covering the types of work outlined
in Section \ref{sect-chargen-jobs}).
...
A character at the beginning of their career will start with about 200~sp
worth of equipment, representing what the've managed to accumulate while
getting established during the first year or so of work. At the DM's
discretion, character background may modify this amount. It is usually
consistent across income levels: characters in skilled professions had to
pay tuition and dues membership to get there, and characters in unskilled
jobs would have spent an extra year or two getting established before the
campaign starts.
